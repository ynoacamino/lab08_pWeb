...
my $sth = $dbh->prepare("SELECT * FROM Movie WHERE points > ? AND votes > ?");

$sth->execute($points, $votes);
...
print "<strong> Las películas con puntaje mayor a 7 y más de 5000 votos son: </strong";
